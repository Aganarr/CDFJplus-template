...
int main()
{
    ...
    while (1)
    {
        ...
        {
            printf("Invalid WAV file. File must be a standard uncompressed PCM WAV.\n\n");
            fclose(file);
            continue;
        }
        ...
        if (verbose) printf("Sample Rate: %u Hz\n", sampleRate);
        ...
        for (unsigned int i = 0; i < sampleCount; i++)
        {
            ...
            if (in16 < smallest) smallest = in16;
            if (in16 > biggest)  biggest = in16;
        }
